...
plate7 = labware.load('96-flat', '10') # loads a 96-flat plate
plate8 = labware.load('96-flat', '11') # loads a 96-flat plate
# reservoir
...
for i in range(12):
	pipette.pick_up_tip()
	pipette.transfer(7, reservoir1.cols(i), plate1.cols(i).bottom(7), mix_before = (2, 40), new_tip = 'never')
	pipette.transfer(7, reservoir1.cols(i), plate2.cols(i).bottom(7), new_tip = 'never')
	pipette.transfer(7, reservoir1.cols(i), plate3.cols(i).bottom(7), new_tip = 'never')
	pipette.transfer(7, reservoir1.cols(i), plate4.cols(i).bottom(7), new_tip = 'never')
	pipette.transfer(7, reservoir1.cols(i), plate5.cols(i).bottom(7), mix_before = (2, 40), new_tip = 'never')
	pipette.transfer(7, reservoir1.cols(i), plate6.cols(i).bottom(7), new_tip = 'never')
	pipette.transfer(7, reservoir1.cols(i), plate7.cols(i).bottom(7), new_tip = 'never')
	pipette.transfer(7, reservoir1.cols(i), plate8.cols(i).bottom(7), new_tip = 'never')
	pipette.drop_tip()
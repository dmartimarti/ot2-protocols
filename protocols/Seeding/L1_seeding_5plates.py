...
for i in range(12):
	pipette.pick_up_tip()
	pipette.transfer(8, reservoir.cols('1'), plate1.cols(i).bottom(8), mix_before = (2, 50), new_tip = 'never')
	pipette.transfer(8, reservoir.cols('1'), plate2.cols(i).bottom(8), mix_before = (2, 50), new_tip = 'never')
	pipette.transfer(8, reservoir.cols('1'), plate3.cols(i).bottom(8), mix_before = (2, 50), new_tip = 'never')
	pipette.transfer(8, reservoir.cols('1'), plate4.cols(i).bottom(8), mix_before = (2, 50), new_tip = 'never')
	pipette.transfer(8, reservoir.cols('1'), plate5.cols(i).bottom(8), mix_before = (2, 50), new_tip = 'never')
	pipette.drop_tip()

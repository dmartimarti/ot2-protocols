...
for i in range(6):
	...
	pipette.transfer(50, bacteria.cols(i), plate1.cols(i + 6).top(), mix_before = (1, 100), new_tip = 'never')
	# plate 2
	pipette.transfer(50, bacteria.cols(i), plate2.cols(i).top(), mix_before = (1, 100), new_tip = 'never')
	pipette.transfer(50, bacteria.cols(i), plate2.cols(i + 6).top(), mix_before = (1, 100), new_tip = 'never')
	# plate 3
	pipette.transfer(50, bacteria.cols(i), plate3.cols(i).top(), mix_before = (1, 100), new_tip = 'never')
	pipette.transfer(50, bacteria.cols(i), plate3.cols(i + 6).top(), mix_before = (1, 100), new_tip = 'never')
	# plate 4
	pipette.transfer(50, bacteria.cols(i), plate4.cols(i).top(), mix_before = (1, 100), new_tip = 'never')
	pipette.transfer(50, bacteria.cols(i), plate4.cols(i + 6).top(), mix_before = (1, 100), new_tip = 'never')
	# plate 5
	pipette.transfer(50, bacteria.cols(i), plate5.cols(i).top(), mix_before = (1, 100), new_tip = 'never')
	pipette.transfer(50, bacteria.cols(i), plate5.cols(i + 6).top(), mix_before = (1, 100), new_tip = 'never')
	# plate 6
	pipette.transfer(50, bacteria.cols(i), plate6.cols(i).top(), mix_before = (1, 100), new_tip = 'never')
	pipette.transfer(50, bacteria.cols(i), plate6.cols(i + 6).top(), mix_before = (1, 100), new_tip = 'never')	
	# control
	pipette.transfer(50, bacteria.cols(i), control.cols(i).top(), mix_before = (1, 100), new_tip = 'never')
	pipette.transfer(50, bacteria.cols(i), control.cols(i + 6).top(), mix_before = (1, 100), trash = True)

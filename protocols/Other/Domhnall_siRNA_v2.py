...
for i in range(12):
	pipette.pick_up_tip()
	pipette.aspirate(23, reservoir1.cols(i).bottom(2))
	pipette.dispense(3.6, plate1.cols(i))
	pipette.dispense(3.6, plate2.cols(i))
	pipette.dispense(3.6, plate3.cols(i))
	pipette.dispense(3.6, plate4.cols(i))
	pipette.dispense(3.6, plate5.cols(i))
	pipette.dispense(3.6, plate6.cols(i))
	pipette.drop_tip()
